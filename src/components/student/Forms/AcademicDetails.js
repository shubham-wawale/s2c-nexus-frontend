...
export default function AcademicDetails() {
  ...
  const handleAcademicDetailSubmit = (e) => {
    ...
    var payload = {
      ...
      twelfth: {
        marks: academicData.seniorSecondary=="twelfth" ?  academicData.twelfthPassingMarks : "",
        passingYear: academicData.seniorSecondary=="twelfth" ?  academicData.twelfthPassingYear : ""
      },
      diploma: {
        marks: academicData.seniorSecondary=="twelfth" ?  academicData.twelfthPassingMarks : "",
        passingYear: academicData.seniorSecondary=="twelfth" ?  academicData.twelfthPassingYear : ""
      ...
      <div className='font-open-sans overflow-scroll scrollbar-hide h-105 mx-4 shadow-md border-b mb-5 rounded-md'>
        ...
        <div className='mx-5 mt-2 grid grid-cols-3 gap-4'>
          <div class="mb-3 cols-span-1">
            ...
            <input name='degreePassingYear' onChange={handleInputChange} type="text" class="shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-1.5  w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
          </div>
          <div class="mb-3 cols-span-1">
            <label for="department" class="block text-sm font-bold text-[#1F2937]">Department</label>
            <input name='department' onChange={handleInputChange} type="text" class="shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-1.5  w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
          </div>
          <div class=" cols-span-1">
            <label for="degreeCgpa" class="block  text-sm font-bold text-[#1F2937]">BE CGPA</label>
            <input name='degreeCgpa' onChange={handleInputChange} type="text" class=" cursor-pointer shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-1.5  w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
          </div>
          <div class=" cols-span-1">
            <label for="degreeCgpaInPercentage" class="block  text-sm font-bold text-[#1F2937]">BE CGPA in Percentage</label>
            <input name='degreeCgpaInPercentage' onChange={handleInputChange} type="text" class=" cursor-pointer shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-1.5  w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
          </div>
          {/* <div class="mb-3 cols-span-1">
          ...
          <div class="mb-3 cols-span-1">
            ...
            <input name='academicGap' onChange={handleInputChange} type="text" class=" cursor-pointer shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-1.5  w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
          </div>
          <div class="mb-3 cols-span-1">
            <label for="degreeGap" class="block  text-sm font-bold text-[#1F2937]">Degree Gap Years</label>
            <input name='degreeGap' onChange={handleInputChange} type="text" class=" cursor-pointer shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-1.5  w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
          </div>
        </div>
        <div className="left-0 my-2 uppercase focus:outline-none border-none 
